...
const ERROR_PATTERNS = [
  ...
  },
  {
    ...
    patterns: [/not.*found/i, /no.*element/i, /selector.*not/i, /composer.*not.*found/i],
    retry: true,
    baseDelayMin: 5,
    alertLevel: null
  },
  {
    ...
    patterns: [/timeout/i, /navigation.*timeout/i, /waiting.*selector/i, /ERR_CONNECTION/i],
    retry: true,
    baseDelayMin: 5,
    alertLevel: null
  },
  ...
  {
    type: 'BROWSER_CRASH',
    patterns: [/Target.*closed/i, /browser.*closed/i, /context.*destroyed/i, /Protocol error/i, /browser.*disconnected/i, /crashed/i, /page.*closed/i],
    retry: true,
    baseDelayMin: 1,
    alertLevel: null
  },
