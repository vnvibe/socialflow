    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={onClose}>
      ...
      >
        ...
        <div className="overflow-y-auto flex-1 px-5 py-4 space-y-4">
          {/* Group FB ID */}
          <div>
            <label className="block text-sm font-medium text-app-primary mb-1">Group ID</label>
            <input
              type="text"
              ...
              className="w-full rounded-lg border border-app-border px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-app-elevated"
            />
          </div>

          {/* Group Name */}
          <div>
            <label className="block text-sm font-medium text-app-primary mb-1">Tên nhóm</label>
            <input
              type="text"
          ...
          {/* Account */}
          <div>
            <label className="block text-sm font-medium text-app-primary mb-1">Tài khoản theo dõi</label>
            <select
          ...
          {/* Campaign (optional) */}
          <div>
            <label className="block text-sm font-medium text-app-primary mb-1">Chiến dịch (tùy chọn)</label>
            <select
          ...
          {/* Brand Name */}
          <div>
            <label className="block text-sm font-medium text-app-primary mb-1">Tên thương hiệu</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-medium text-app-primary mb-1">Từ khóa thương hiệu</label>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 rounded-lg border border-app-border px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              />
              <button
                onClick={addKeyword}
                disabled={!keywordInput.trim()}
                className="px-3 py-2 rounded-lg bg-app-elevated text-app-muted hover:bg-app-hover disabled:opacity-50"
              >
                <Plus size={16} />
              </button>
            </div>
          ...
          {/* Brand Voice */}
          <div>
            <label className="block text-sm font-medium text-app-primary mb-1">Giọng điệu thương hiệu</label>
            <textarea
              value={form.brand_voice}
              onChange={e => setForm(f => ({ ...f, brand_voice: e.target.value }))}
              rows={2}
              placeholder="VD: thân thiện, tự nhiên, không quảng cáo lộ"
              className="w-full rounded-lg border border-app-border px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 resize-none"
            />
          </div>
          ...
          <div>
            ...
            />
            <div className="flex justify-between text-xs text-app-dim mt-0.5">
              <span>Rộng (1)</span>
              <span>Chặt (10)</span>
            </div>
          </div>
          ...
          {/* Scan Interval */}
          <div>
            <label className="block text-sm font-medium text-app-primary mb-1">Tần suất scan</label>
            <select
        ...
        {/* Footer */}
        <div className="px-5 py-3.5 border-t border-app-border flex justify-end gap-2">
          <button
            onClick={onClose}
            className="px-4 py-2 rounded-lg border border-app-border text-sm font-medium hover:bg-app-base"
          >
            Hủy
          </button>
          <button
            ...
            className="px-4 py-2 rounded-lg bg-info text-white text-sm font-medium hover:opacity-90 disabled:opacity-50 flex items-center gap-2"
          >
